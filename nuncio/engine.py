...
from nuncio.redactor import count_redactions, redact, scrub_for_knowledge_plane
...
class Engine:
    ...
    def _garnish_with_knowledge(self, alert, enrichment_text, deadline, depth=None):
        ...
        try:
            ...
            try:
                raw = run_bounded(
                    lambda: self.knowledge_llm.enrich(build_knowledge_messages(generic_prompt), timeout=bound), bound)
            except Exception:
                return enrichment_text
